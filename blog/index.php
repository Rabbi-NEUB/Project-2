...
<body>
  ...
  <header class="clearfix">
    <div class="logo">
      <a href="index.php">
        <h1 class="logo-text"><span>Bl</span>og</h1>
      </a>
    </div>
          ...
          <div class="inner-post">
            ...
            <div class="post-info">
              <h4><a href="single.php">One day your life will flash before your eyes</a></h3>
                <div>
                  <i class="fa fa-user-o"></i> Fazle Rabbi
                  &nbsp;
                  <i class="fa fa-calendar"></i> Mar 18, 2020
                </div>
            </div>
          </div>
        </div>
            ...
            <div class="post-info">
              <h4><a href="single.php">One day your life will flash before your eyes</a></h3>
                <div>
                  <i class="fa fa-user-o"></i> Fazle Rabbi
                  &nbsp;
                  <i class="fa fa-calendar"></i> Mar 19, 2020
                </div>
            </div>
          </div>
        </div>
  ...
  <div class="footer">
    <div class="footer-content">
      <div class="footer-section about">
        <h1 class="logo-text">Bl<span>og</span></h1>
        <p>
          This is a fictional blog conceived for the purpose
          of Profect work 2.
        </p>
        <!-- <br> -->
    ...
    <div class="footer-bottom">
      <p>© Coding Poets | Designed by Fazle Rabbi</p>
    </div>
  </div>
  <!-- // FOOTER -->
